![Build status](https://github.com/DEFRA/flood-app-temp/actions/workflows/ci.yml/badge.svg)[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_flood-app-temp&metric=alert_status)](https://sonarcloud.io/dashboard?id=DEFRA_flood-app-temp)[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_flood-app-temp&metric=coverage)](https://sonarcloud.io/dashboard?id=DEFRA_flood-app-temp)
